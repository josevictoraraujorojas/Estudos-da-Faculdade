...
public class GuiEditarEmprestimo extends JFrame{
    JLabel textotitulo;
    JTextField titulo;
    ...
    public GuiEditarEmprestimo() {
        ...
        textoDataReserva = new JLabel("Data emprestimo");
        ...
        textoHoraReserva = new JLabel("Hora emprestimo");

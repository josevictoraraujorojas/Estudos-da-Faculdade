...
Main {
    ...
    public static void cadastraLivro() throws Exception {
        ...
        if (auxilaiar.ler(titulo)!=null){
            ...
            Java.Periodo3.POO.Biblioteca.Parte2.Livros livro = new Java.Periodo3.POO.Biblioteca.Parte2.Livros(titulo, autor, area, editora, ano, edicao, numeroDePaginas);
            livro.gravar();
        }
    }
    ...
    public static void cadastraFuncionario() throws Exception {
        ...
        if (auxiliar.ler(nome)!=null){
            ...
            Java.Periodo3.POO.Biblioteca.Parte2.Funcionario funcionario = new Funcionario(nome, idade, sexo, telefone, departamento, cargo);
            funcionario.gravar();
        }
    }
    ...
    public static void cadastraEmprestimo() throws Exception {
        ...
        Java.Periodo3.POO.Biblioteca.Parte2.Livros livro=null;
        Usuario usuario;
        ...
        Java.Periodo3.POO.Biblioteca.Parte2.Emprestimos emprestimo =new Java.Periodo3.POO.Biblioteca.Parte2.Emprestimos(dataDoEmprestimo,horaDoEmprestimo,livro,usuario);

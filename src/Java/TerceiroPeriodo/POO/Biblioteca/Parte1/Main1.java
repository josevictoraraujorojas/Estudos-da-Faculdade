...
public class Main1 {
    ...
    static ArrayList<Java.TerceiroPeriodo.POO.Biblioteca.Parte1.Livros> livros = new ArrayList<>();
    static ArrayList<Java.TerceiroPeriodo.POO.Biblioteca.Parte1.Emprestimos> emprestimos = new ArrayList<>();
    ...
    public static void cadastraLivro() throws Exception {
        ...
        Java.TerceiroPeriodo.POO.Biblioteca.Parte1.Livros livro = new Java.TerceiroPeriodo.POO.Biblioteca.Parte1.Livros(titulo,autor,area,editora,ano,edicao,numeroDePaginas);
        livros.add(livro);
    }
    public static void cadastraEstudante() throws Exception {
        ...
        Java.TerceiroPeriodo.POO.Biblioteca.Parte1.Estudande estudante = new Estudande(nome,idade,sexo,telefone,matricula,curso,periodo);
    ...
    public static void cadastraProfessor() throws Exception {
        ...
        Java.TerceiroPeriodo.POO.Biblioteca.Parte1.Professor professor = new Professor(nome,idade,sexo,telefone,formacaoAcademica,cursoMinistrado);
    ...
    public static void cadastraFuncionario() throws Exception {
        ...
        Java.TerceiroPeriodo.POO.Biblioteca.Parte1.Funcionario funcionario = new Funcionario(nome,idade,sexo,telefone,departamento,cargo);
    ...
    public static void cadastraEmprestimo() throws Exception {
        ...
        Java.TerceiroPeriodo.POO.Biblioteca.Parte1.Emprestimos emprestimo =new Java.TerceiroPeriodo.POO.Biblioteca.Parte1.Emprestimos(dataDoEmprestimo,horaDoEmprestimo,livro,usuario);
    ...
    public static void realizaDevolucao() throws Exception {
        ...
        Usuarios usuario;
        Java.TerceiroPeriodo.POO.Biblioteca.Parte1.Livros livro;
        Java.TerceiroPeriodo.POO.Biblioteca.Parte1.Emprestimos emprestimo;
        System.out.println("escreva o seu nome de usuario");
        nomeUsuario =scanner.nextLine();
    ...
    public static Java.TerceiroPeriodo.POO.Biblioteca.Parte1.Livros buscaLivro(String titulo){
        for (Java.TerceiroPeriodo.POO.Biblioteca.Parte1.Livros atual:livros) {
    ...
    public static boolean contemEmprestimo(Java.TerceiroPeriodo.POO.Biblioteca.Parte1.Livros livro, Usuarios usuario){
        for (Java.TerceiroPeriodo.POO.Biblioteca.Parte1.Emprestimos atual:emprestimos) {
    ...
    public static Java.TerceiroPeriodo.POO.Biblioteca.Parte1.Emprestimos buscaEmprestimo(Java.TerceiroPeriodo.POO.Biblioteca.Parte1.Livros livro, Usuarios usuario){
        for (Java.TerceiroPeriodo.POO.Biblioteca.Parte1.Emprestimos atual:emprestimos) {
            if (atual.getLivro().equals(livro)&&atual.getUsuario().equals(usuario))
                return atual;
        }

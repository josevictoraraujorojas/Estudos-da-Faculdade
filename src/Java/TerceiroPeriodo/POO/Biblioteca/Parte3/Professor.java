...
public class Professor extends Usuario {
    ...
    public void gravar() throws Exception {
        try {
            FileOutputStream file = new FileOutputStream("C:\\BibliotecaParte3/UsuarioProfessor"+getLogin());
    ...
    public boolean excluir() throws Exception {
        try {
            Files.delete(Path.of("C:\\BibliotecaParte3/UsuarioProfessor" + getLogin()));
            return true;
        }catch (Exception erro){
            throw new Exception(erro.toString());
        }
    ...
    public Object ler(String login) throws Exception {
        try {
            FileInputStream file = new FileInputStream("C:\\BibliotecaParte3/UsuarioProfessor"+login);
    ...
    public void atualizar() throws Exception {
        try {
            FileOutputStream file = new FileOutputStream("C:\\BibliotecaParte3/UsuarioProfessor"+getNome());
            ObjectOutputStream escreve = new ObjectOutputStream(file);
            escreve.writeObject(this);
            escreve.flush();
            escreve.close();

...
public class teste {
    public static void main(String[] args) throws InterruptedException {
        ...
        while (barco!=9) {
            ...
            if (verificaBarco(linha, coluna, tabuleiro)) {
                barco++;
                Thread.sleep(1000);
                System.out.println("embarcação destruída");
                Thread.sleep(1000);
                System.out.println("total de barcos encontrados: " + barco);
                Thread.sleep(1000);
    ...
    public static boolean verificaBarco(int f, int c, String[][] x) {
        return x[f][c].equals("/");
    }
